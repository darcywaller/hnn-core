...
def _long_name(short_name):
    long_name = dict(L2Basket='L2_basket', L5Basket='L5_basket', L2GABAbBasket='L2GABAb_basket',
...
def _short_name(short_name):
    long_name = dict(L2_basket='L2Basket', L5_basket='L5Basket', L2GABAb_basket='L2GABAbBasket',
...
def check_evoked_synkeys(p, nprox, ndist):
    ...
    lctdist = ['L2Pyr', 'L5Pyr', 'L2Basket', 'L2GABAbBasket']
...
def check_pois_synkeys(p):
    ...
    lct = ['L2Pyr', 'L5Pyr', 'L2Basket', 'L2GABAbBasket', 'L5Basket']  # target cell types
