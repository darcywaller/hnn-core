...
def law_2021_model(params=None, add_drives_from_params=False,
    ...
    net.connectivity[3]['nc_dict']['A_weight'] = 0.0003
    net.connectivity[2]['nc_dict']['A_weight'] = 0.0003
    #net.connectivity[0]['nc_dict']['A_weight'] = 0.0003
    #net.connectivity[1]['nc_dict']['A_weight'] = 0.0003
    
    # Modify L2_basket -> L2_pyramidal inhibition
    net.connectivity[4]['nc_dict']['A_weight'] = 0.03  # gabaa
    net.connectivity[5]['nc_dict']['A_weight'] = 0.001  # .00026 gabab
    
    # Modify L5_basket -> L5_pyramidal inhibition
    net.connectivity[6]['nc_dict']['A_weight'] = 0.03  # gabaa
    net.connectivity[7]['nc_dict']['A_weight'] = 0.001  # gabab
    ...
    #del net.connectivity[4] # gabaa onto L2 pyr
    #del net.connectivity[5] # gabab onto L2 pyr
...
def diesburg_2024_model(params=None, add_drives_from_params=False,
                        legacy_mode=False):
    ...
    net.connectivity[0]['nc_dict']['A_weight'] = .00075 # nmda
    net.connectivity[1]['nc_dict']['A_weight'] = .00075 # ampa
    ...
    # scale other weights
    #net.connectivity[6]['nc_dict']['A_weight'] = 0.000125  # .025 
    #net.connectivity[10]['nc_dict']['A_weight'] = 5e-06  # .001 
    #net.connectivity[11]['nc_dict']['A_weight'] = 2.5e-05  # .0005 
    #net.connectivity[12]['nc_dict']['A_weight'] = 0.0001  # .02 
    #net.connectivity[13]['nc_dict']['A_weight'] = 0.0001  # .02
    #net.connectivity[14]['nc_dict']['A_weight'] = 2.5e-05  # .0005 
    #net.connectivity[15]['nc_dict']['A_weight'] = 1.25e-06  # .00025 

    # other law model changes
    # Remove L2_basket -> L5_pyramidal gabaa connection
    #del net.connectivity[10]  # Original paper simply sets gbar to 0.0
